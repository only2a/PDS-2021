...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(304, "Семантическая ошибка: В объявлении отсутствует ключевое слова"),
		...
		ERROR_ENTRY(319, "Семантическая ошибка: Присвоение типу unum отрицательного значения"),
